...
var opts struct {
	...
	ProcessFHTTPDMetrics bool   `short:"f" long:"process-fhttpd" env:"PROCESS_FHTTPD" description:"Process and export messages that are generated by fhttpd component"`
}
