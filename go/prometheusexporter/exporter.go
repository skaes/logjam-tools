...
var opts struct {
	...
	ProcessWebvitals bool   `short:"w" long:"process-webvitals" description:"Process webvitals messages and export them"`
	ProcessAjax      bool   `short:"j" long:"process-ajax" description:"Process ajax requests messages and export them"`
}
...
func main() {
	...
	collectorOptions := collector.Options{
		...
		ProcessWebvitals: opts.ProcessWebvitals,
		ProcessAjax:      opts.ProcessAjax,
	}
